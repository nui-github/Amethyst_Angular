...
export const STATUS_META: Record<ShipmentStatus, { label: string; bg: string; text: string; dot: string }> = {
  ...
  returned_for_edit: { label: 'ส่งกลับเพื่อแก้ไข',   bg: '#F5F3FF', text: '#6D28D9', dot: '#7C3AED' },
  rejected:          { label: 'ไม่อนุมัติ',          bg: '#FEF2F2', text: '#B91C1C', dot: '#EF4444' },
...
export const MOCK_QUEUE: Shipment[] = [
  ...
  // ── 20. needs_you (EXP): Rubber Compound Block – ขาออก การยาง (ยางผสม, รอเลือก e-QC/e-SFR) ──
  {
    ...
    agency: 'raot', permitNeeded: true, formCode: 'e-SFR/e-QC',
  ...
  // ── 26. needs_you: DMF (เชื้อเพลิง) — ขอออกของไปก่อน, รอยืนยันส่งกรม (ยังไม่ถึง DMF ACCEPT) ──
  {
    ...
    isNew: true, type: 'IMP',
    goods: 'วัสดุ/อุปกรณ์สำหรับกิจการปิโตรเลียม (ขอออกของไปก่อน ยกเว้นอากร ม.70)', hs: '4016.90.90',
    customer: 'บริษัท ไทยเอ็กซ์พลอเรชั่น ปิโตรเลียม จำกัด', contact: 'นายวิศรุต ปิโตรกิจ',
    contactEmail: 'wisarut@thaiexploration.co.th',
    origin: 'ญี่ปุ่น (JP)', importedAt: '08:00 น. วันนี้', createdAt: NOW - 1 * 3600_000, owner: 'ปวีณา ส.',
    agency: 'dmf', permitNeeded: true, formCode: 'DMF License',
    formName: 'คำร้องขอออกของไปก่อน เพื่อยกเว้นอากรฯ — กรมเชื้อเพลิงธรรมชาติ (DMF)',
    conf: 91, stage: 6, statusKey: 'needs_you',
    assess: { conf: 91, reason: 'วัสดุ/อุปกรณ์สำหรับกิจการปิโตรเลียม เข้าเงื่อนไขยกเว้นอากรตามมาตรา 70 พ.ร.บ.ปิโตรเลียม พ.ศ. 2514 — ต้องยื่นคำร้องขอออกของไปก่อนกับกรมเชื้อเพลิงธรรมชาติ' },
    classify: { agency: 'dmf', conf: 91, reason: '', alt: [] },
    draft: { fields: [] },
    flags: [],
    audit: [
      { time: '08:00', text: 'อัปโหลดใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000501 เข้าระบบแล้ว', by: 'ระบบ' },
      { time: '08:05', text: 'OCR อ่านใบขนขาเข้าสำเร็จ — ตรวจพบเป็นคำร้องขอออกของไปก่อน (ม.70)', by: 'AI' },
      { time: '08:20', text: 'กรอกข้อมูลเพิ่มเติมในแบบฟอร์ม DMF ครบถ้วนแล้ว', by: 'ปวีณา ส.' },
      { time: '08:25', text: 'ตรวจสอบข้อมูลก่อนส่งกรมแล้ว — รอกดยืนยันส่งกรม', by: 'ปวีณา ส.' },
    ],
    messages: [
      bot('08:00', 'อัปโหลดใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000501 เข้าระบบแล้วครับ — ตรวจพบเป็นคำร้องขอออกของไปก่อน เพื่อยกเว้นอากรนำเข้า (มาตรา 70 พ.ร.บ.ปิโตรเลียม)'),
      bot('08:05', 'OCR อ่านใบขนขาเข้าสำเร็จ พบวัสดุ/อุปกรณ์สำหรับกิจการปิโตรเลียม 4 รายการ มูลค่ารวม ฿61,849,166 — กรุณากรอกข้อมูลเพิ่มเติมให้ครบก่อนดำเนินการต่อ'),
      usr('08:20', 'กรอกข้อมูลเพิ่มเติมเรียบร้อยแล้ว'),
      t('08:25', 'bot', 'form-preview', undefined, {
        invoiceNo: 'TEP-INV-2026-0317', importer: 'บริษัท ไทยเอ็กซ์พลอเรชั่น ปิโตรเลียม จำกัด', port: '0109',
        countryOrigin: 'ญี่ปุ่น (JP)', goodsDesc: 'วัสดุ/อุปกรณ์สำหรับกิจการปิโตรเลียม (ขอออกของไปก่อน ยกเว้นอากร ม.70)',
        licenseType: 'ขอออกของไปก่อน (ยกเว้นอากร ม.70 พ.ร.บ.ปิโตรเลียม)',
      }),
    ],
    documents: [
      doc('d26a', 'ใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000501', 'customs', 'other'),
    ],
    itemsSelected: true,
    items: [
      { id: 'i26_1', name: 'ท่อกรุบ่อน้ำมัน (Casing Pipe)', hsCode: '4016.90.90', origin: 'ญี่ปุ่น (JP)', quantity: '850', unit: 'PCE', lotNo: '-', amount: 16677340 },
      { id: 'i26_2', name: 'หัวเจาะสามง่าม (Tricone Drill Bit)', hsCode: '8431.43.00', origin: 'สหรัฐอเมริกา (US)', quantity: '24', unit: 'PCE', lotNo: '-', amount: 6116352 },
      { id: 'i26_3', name: 'ชุดวาล์วควบคุมหลุมเจาะ (Wellhead Christmas Tree)', hsCode: '8481.80.99', origin: 'นอร์เวย์ (NO)', quantity: '6', unit: 'SET', lotNo: '-', amount: 24759714 },
      { id: 'i26_4', name: 'ท่อผลิตปิโตรเลียม (Production Tubing)', hsCode: '7304.23.00', origin: 'ญี่ปุ่น (JP)', quantity: '1200', unit: 'PCE', lotNo: '-', amount: 14295760 },
    ],
  },
  ...
  // chat.service.ts ซึ่งใช้กฎเดียวกัน)
  {
    ...
    flags: [],
    audit: [
      { time: '09:10', text: 'อัปโหลดใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000502 เข้าระบบแล้ว', by: 'ระบบ' },
      { time: '09:15', text: 'OCR อ่านใบขนขาเข้าสำเร็จ — ตรวจพบเป็นคำร้องขอออกของไปก่อน (ม.70)', by: 'AI' },
      { time: '09:30', text: 'ยืนยันส่งกรมแล้ว', by: 'ปวีณา ส.' },
      { time: '09:31', text: 'ยื่นข้อมูลผ่านระบบคอมพิวเตอร์ไปยังกรมเชื้อเพลิงธรรมชาติแล้ว', by: 'ระบบ' },
      { time: '09:34', text: 'กรมเชื้อเพลิงธรรมชาติรับข้อมูลแล้ว (DMF ACCEPT) — รอผลพิจารณาออกใบอนุญาต', by: 'กรมเชื้อเพลิงธรรมชาติ' },
    ],
    messages: [
      bot('09:10', 'อัปโหลดใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000502 เข้าระบบแล้วครับ — ตรวจพบเป็นคำร้องขอออกของไปก่อน เพื่อยกเว้นอากรนำเข้า (มาตรา 70 พ.ร.บ.ปิโตรเลียม)'),
      usr('09:30', 'ยืนยันส่งกรม'),
      t('09:34', 'bot', 'dmf-submission-status', undefined, {
        agency: 'กรมเชื้อเพลิงธรรมชาติ', referenceNumber: 'NETB000000502', status: 'dmf-accept',
        declNo: 'A0173630700055', declDate: '2568-07-23',
        companyNameTh: 'บริษัท ไทยเอ็กซ์พลอเรชั่น ปิโตรเลียม จำกัด', companyNameEn: 'Thai Exploration Petroleum Co., Ltd.',
        taxNumber: '0105568004421', branch: '00000',
        address: '99 อาคารเอนเนอร์ยี่คอมเพล็กซ์ ถนนวิภาวดีรังสิต แขวงจตุจักร เขตจตุจักร กรุงเทพฯ 10900',
        items: [
          { itemNo: 1, invNo: 'TEP-INV-2026-0317', invItem: '1', tariff: '4016.90.90', stat: '000', enDesc: 'Well Casing Pipe, Seamless Steel', thDesc: 'ท่อกรุบ่อน้ำมัน (Casing Pipe)', pk: '850 PCE', nw: '82,500.000 KGM', qty: '850 PCE', invAmount: '460,700.00 USD', cifForeign: '509,500.00 USD', cifBaht: '18,450,000.00', dutyExempt: true },
          { itemNo: 2, invNo: 'TEP-INV-2026-0317', invItem: '2', tariff: '8431.43.00', stat: '000', enDesc: 'Tricone Drill Bit', thDesc: 'หัวเจาะสามง่าม (Tricone Drill Bit)', pk: '24 PCE', nw: '4,320.000 KGM', qty: '24 PCE', invAmount: '168,960.00 USD', cifForeign: '169,060.00 USD', cifBaht: '6,120,000.00', dutyExempt: true },
          { itemNo: 3, invNo: 'TEP-INV-2026-0317', invItem: '3', tariff: '8481.80.99', stat: '000', enDesc: 'Wellhead Christmas Tree Valve Assembly', thDesc: 'ชุดวาล์วควบคุมหลุมเจาะ (Wellhead Christmas Tree)', pk: '6 SET', nw: '18,600.000 KGM', qty: '6 SET', invAmount: '683,970.00 USD', cifForeign: '685,080.00 USD', cifBaht: '24,800,000.00', dutyExempt: true },
          { itemNo: 4, invNo: 'TEP-INV-2026-0317', invItem: '4', tariff: '7304.23.00', stat: '000', enDesc: 'Production Tubing, Seamless Steel', thDesc: 'ท่อผลิตปิโตรเลียม (Production Tubing)', pk: '1,200 PCE', nw: '81,000.000 KGM', qty: '1,200 PCE', invAmount: '394,800.00 USD', cifForeign: '394,890.00 USD', cifBaht: '14,300,000.00', dutyExempt: true },
        ],
      }),
    ],
    documents: [
      doc('d27a', 'ใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000502', 'customs', 'other'),
    ],
    dmfSubmission: {
      agency: 'กรมเชื้อเพลิงธรรมชาติ', referenceNumber: 'NETB000000502', status: 'dmf-accept',
      declNo: 'A0173630700055', declDate: '2568-07-23',
    ...
    itemsSelected: true,
    items: [
      { id: 'i27_1', name: 'ท่อกรุบ่อน้ำมัน (Casing Pipe)', hsCode: '4016.90.90', origin: 'ญี่ปุ่น (JP)', quantity: '850', unit: 'PCE', lotNo: '-', amount: 16677340 },
      { id: 'i27_2', name: 'หัวเจาะสามง่าม (Tricone Drill Bit)', hsCode: '8431.43.00', origin: 'สหรัฐอเมริกา (US)', quantity: '24', unit: 'PCE', lotNo: '-', amount: 6116352 },
      { id: 'i27_3', name: 'ชุดวาล์วควบคุมหลุมเจาะ (Wellhead Christmas Tree)', hsCode: '8481.80.99', origin: 'นอร์เวย์ (NO)', quantity: '6', unit: 'SET', lotNo: '-', amount: 24759714 },
      { id: 'i27_4', name: 'ท่อผลิตปิโตรเลียม (Production Tubing)', hsCode: '7304.23.00', origin: 'ญี่ปุ่น (JP)', quantity: '1200', unit: 'PCE', lotNo: '-', amount: 14295760 },
    ],
  },

  // ── 28. submitted: DMF (เชื้อเพลิง) — LICENSE ACCEPT แล้ว ────────────────────
  {
    id: 'IMP-68-028503', customsNo: 'NETB000000503',
    isNew: false, type: 'IMP',
    goods: 'วัสดุ/อุปกรณ์สำหรับกิจการปิโตรเลียม (ขอออกของไปก่อน ยกเว้นอากร ม.70)', hs: '4016.90.90',
    customer: 'บริษัท ไทยเอ็กซ์พลอเรชั่น ปิโตรเลียม จำกัด', contact: 'นายวิศรุต ปิโตรกิจ',
    contactEmail: 'wisarut@thaiexploration.co.th',
    origin: 'ญี่ปุ่น (JP)', importedAt: '10:05 น. 3 วันก่อน', createdAt: NOW - 3 * 24 * 3600_000, owner: 'ปวีณา ส.',
    agency: 'dmf', permitNeeded: true, formCode: 'DMF License',
    formName: 'คำร้องขอออกของไปก่อน เพื่อยกเว้นอากรฯ — กรมเชื้อเพลิงธรรมชาติ (DMF)',
    conf: 91, stage: 7, statusKey: 'submitted',
    assess: { conf: 91, reason: 'วัสดุ/อุปกรณ์สำหรับกิจการปิโตรเลียม เข้าเงื่อนไขยกเว้นอากรตามมาตรา 70 พ.ร.บ.ปิโตรเลียม พ.ศ. 2514' },
    ...
    flags: [],
    audit: [
      { time: '10:05', text: 'อัปโหลดใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000503 เข้าระบบแล้ว', by: 'ระบบ' },
      { time: '10:10', text: 'OCR อ่านใบขนขาเข้าสำเร็จ — ตรวจพบเป็นคำร้องขอออกของไปก่อน (ม.70)', by: 'AI' },
      { time: '10:25', text: 'ยืนยันส่งกรมแล้ว', by: 'ปวีณา ส.' },
      { time: '10:26', text: 'ยื่นข้อมูลผ่านระบบคอมพิวเตอร์ไปยังกรมเชื้อเพลิงธรรมชาติแล้ว', by: 'ระบบ' },
      { time: '10:29', text: 'กรมเชื้อเพลิงธรรมชาติรับข้อมูลแล้ว (DMF ACCEPT)', by: 'กรมเชื้อเพลิงธรรมชาติ' },
      { time: '16:45', text: 'อนุมัติใบอนุญาตแล้ว (LICENSE ACCEPT) — เลขที่ใบอนุญาต DMFRS6907/0039', by: 'กรมเชื้อเพลิงธรรมชาติ' },
    ],
    messages: [
      bot('10:05', 'อัปโหลดใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000503 เข้าระบบแล้วครับ — ตรวจพบเป็นคำร้องขอออกของไปก่อน เพื่อยกเว้นอากรนำเข้า (มาตรา 70 พ.ร.บ.ปิโตรเลียม)'),
      usr('10:25', 'ยืนยันส่งกรม'),
      t('10:29', 'bot', 'dmf-submission-status', undefined, {
        agency: 'กรมเชื้อเพลิงธรรมชาติ', referenceNumber: 'NETB000000503', status: 'dmf-accept',
        declNo: 'A0173630700039', declDate: '2568-07-21',
        companyNameTh: 'บริษัท ไทยเอ็กซ์พลอเรชั่น ปิโตรเลียม จำกัด', companyNameEn: 'Thai Exploration Petroleum Co., Ltd.',
        taxNumber: '0105568004421', branch: '00000',
        address: '99 อาคารเอนเนอร์ยี่คอมเพล็กซ์ ถนนวิภาวดีรังสิต แขวงจตุจักร เขตจตุจักร กรุงเทพฯ 10900',
      }),
      t('16:45', 'bot', 'dmf-submission-status', undefined, {
        agency: 'กรมเชื้อเพลิงธรรมชาติ', referenceNumber: 'NETB000000503', status: 'license-accept',
        declNo: 'A0173630700039', declDate: '2568-07-21',
        companyNameTh: 'บริษัท ไทยเอ็กซ์พลอเรชั่น ปิโตรเลียม จำกัด', companyNameEn: 'Thai Exploration Petroleum Co., Ltd.',
        taxNumber: '0105568004421', branch: '00000',
        address: '99 อาคารเอนเนอร์ยี่คอมเพล็กซ์ ถนนวิภาวดีรังสิต แขวงจตุจักร เขตจตุจักร กรุงเทพฯ 10900',
        ...
        license: {
          licenseNo: 'DMFRS6907/0039', issueDate: '2568-07-24', requestNo: 'DMF 6907-00039',
          licenseName: 'ใบอนุญาตตามมาตรา 70 แห่งพระราชบัญญัติปิโตรเลียม พ.ศ.2514',
          licenseIssueAuthority: '4030036183000011', licenseAuthorityName: 'กรมเชื้อเพลิงธรรมชาติ',
          licenseType: 'ขอออกของไปก่อน (Document Type 3)',
          licenseIssueDate: '2568-07-24', effectiveDate: '2568-07-24', expireDate: '9999-12-31',
        },
      }),
    ],
    documents: [
      doc('d28a', 'ใบขนสินค้าขาเข้า (ไฟล์ XML) NETB000000503', 'customs', 'other'),
    ],
    dmfSubmission: {
      agency: 'กรมเชื้อเพลิงธรรมชาติ', referenceNumber: 'NETB000000503', status: 'license-accept',
      declNo: 'A0173630700039', declDate: '2568-07-21',
    ...
    itemsSelected: true,
    items: [
      { id: 'i28_1', name: 'ท่อกรุบ่อน้ำมัน (Casing Pipe)', hsCode: '4016.90.90', origin: 'ญี่ปุ่น (JP)', quantity: '850', unit: 'PCE', lotNo: '-', amount: 16677340 },
      { id: 'i28_2', name: 'หัวเจาะสามง่าม (Tricone Drill Bit)', hsCode: '8431.43.00', origin: 'สหรัฐอเมริกา (US)', quantity: '24', unit: 'PCE', lotNo: '-', amount: 6116352 },
      { id: 'i28_3', name: 'ชุดวาล์วควบคุมหลุมเจาะ (Wellhead Christmas Tree)', hsCode: '8481.80.99', origin: 'นอร์เวย์ (NO)', quantity: '6', unit: 'SET', lotNo: '-', amount: 24759714 },
      { id: 'i28_4', name: 'ท่อผลิตปิโตรเลียม (Production Tubing)', hsCode: '7304.23.00', origin: 'ญี่ปุ่น (JP)', quantity: '1200', unit: 'PCE', lotNo: '-', amount: 14295760 },
    ],
  },
];
