...
export const INVOICE_LINE_ITEMS: OcrLineItem[] = [
  { id: 'l1', name: 'Wellhead Control Valve Assembly (WHV-2201X)', hsCode: '8481.80.99', origin: 'นอร์เวย์ (NO)', qty: '1',   unit: 'ชิ้น' },
  { id: 'l2', name: 'Coronary Stent (TRCR30015X)',         hsCode: '9018.90.90', origin: 'ไอร์แลนด์ (IE)', qty: '39',  unit: 'ชิ้น' },
  { id: 'l3', name: 'Tricone Drill Bit (TCB-1128W)',       hsCode: '8431.43.00', origin: 'สหรัฐอเมริกา (US)', qty: '29',  unit: 'ชิ้น' },
...
export const INVOICE_CUSTOMS_ITEMS: CustomsDeclarationItem[] = [
  {
    ...
    nameTh: 'ชุดวาล์วควบคุมหลุมเจาะ', nameEn: 'Wellhead Control Valve Assembly (WHV-2201X)',
    tariffCode: '8481809900', quantity: '1', quantityUnit: 'ชิ้น',
    netWeight: '0.450', netWeightUnit: 'KGM', packageAmount: '1', packageUnit: 'BOX',
    originCountry: 'นอร์เวย์ (NO)', purchaseCountry: 'นอร์เวย์ (NO)',
    invoiceAmountForeign: '18500.00', currencyCode: 'EUR', invoiceAmountBaht: '712400.00',
    manufacture: 'Aker Solutions Norway AS, Bergen, Norway',
    remark: 'นำเข้าเพื่อใช้ในกิจการปิโตรเลียม — ขอออกของไปก่อน (ยกเว้นอากร ม.70 พ.ร.บ.ปิโตรเลียม)',
    certificateAnalysis: 'COA-WHV-2201X-2568',
    location: {
    ...
    productions: [{ lotNo: 'WHV-2201X', mfgDate: '01-02-2568', expDate: '01-02-2571', measurement: '1', measurementUnit: 'ชิ้น', quantity: '1', quantityUnit: 'ชิ้น' }],
  },
  {
  ...
  },
  {
    ...
    nameTh: 'หัวเจาะสามง่าม', nameEn: 'Tricone Drill Bit (TCB-1128W)',
    tariffCode: '8431430000', quantity: '29', quantityUnit: 'ชิ้น',
    netWeight: '2.100', netWeightUnit: 'KGM', packageAmount: '2', packageUnit: 'BOX',
    originCountry: 'สหรัฐอเมริกา (US)', purchaseCountry: 'สหรัฐอเมริกา (US)',
    invoiceAmountForeign: '84300.00', currencyCode: 'USD', invoiceAmountBaht: '3011300.00',
    manufacture: 'Halliburton Drilling Equipment Inc., Houston, USA',
    remark: 'นำเข้าเพื่อใช้ในกิจการปิโตรเลียม — ขอออกของไปก่อน (ยกเว้นอากร ม.70 พ.ร.บ.ปิโตรเลียม)',
    certificateAnalysis: 'COA-TCB-1128W-2568',
    productions: [{ lotNo: 'TCB-1128W', mfgDate: '20-01-2568', expDate: '20-01-2571', measurement: '29', measurementUnit: 'ชิ้น', quantity: '29', quantityUnit: 'ชิ้น' }],
  },
  {
